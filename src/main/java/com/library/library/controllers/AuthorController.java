...
public class AuthorController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponseModel> patchAuthor(@PathVariable Integer id, @RequestBody Map<String, Object> request_body) {
        return author_service.patchAuthor(id, request_body);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponseModel> deleteAuthor(@PathVariable Integer id) {
